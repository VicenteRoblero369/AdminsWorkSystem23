...
{
    public partial class TablaUsuarioDatosTodos : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormatosUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Especialidades_Unidades_UnidadesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Especialidades_EspecialidadesId",
                        column: x => x.EspecialidadesId,
                        principalTable: "Especialidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Unidades_UnidadesId",
                        column: x => x.UnidadesId,
                        principalTable: "Unidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estatu = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Constancia_AspNetUsers_UsuarioAplicacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnidadReceptora = table.Column<string>(type: "nvarchar(90)", maxLength: 90, nullable: false),
                    Programa = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SubPrograma = table.Column<string>(type: "nvarchar(90)", maxLength: 90, nullable: false),
                    Actividad = table.Column<string>(type: "nvarchar(90)", maxLength: 90, nullable: false),
                    FechaLiberacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Estado = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EstadoPais = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Municipio = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SemestreActual = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GrupoActual = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Archivo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Imagenes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    statusUsTS = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_evidenciaOReporte", x => x.Id);
                    table.ForeignKey(
                        name: "FK_evidenciaOReporte_AspNetUsers_UsuarioAplicacionId",
                        column: x => x.UsuarioAplicacionId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_EspecialidadesId",
                table: "AspNetUsers",
                column: "EspecialidadesId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UnidadesId",
                table: "AspNetUsers",
                column: "UnidadesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Constancia_UsuarioAplicacionId",
                table: "Constancia",
                column: "UsuarioAplicacionId");

            migrationBuilder.CreateIndex(
                name: "IX_Especialidades_UnidadesId",
                table: "Especialidades",
                column: "UnidadesId");

            migrationBuilder.CreateIndex(
                name: "IX_evidenciaOReporte_UsuarioAplicacionId",
